// *******************************************
// * Chupon's SuperScript (All IN ONE) vXI   * 
// *******************************************
...
'&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>Rest Below</label>&nbsp&nbsp<input type="number" size="1" id="RestMin" value="80" min="1" max="100" onchange="FixRestPercent()" style="width: 3em;">' +
'<label>%HP</label>&nbsp&nbsp&nbsp&nbsp&nbsp<label>&nbspMax</label><input type="number" size="1" id="RestMax" value="100" min="1" max="100" onchange="FixRestPercent()" style="width: 3em;"><label>%HP</label>' +
...
'<input type="number" size="1" id="HealBelow" value="90" min="1" max="100" onchange="FixHealPercent()" style="width: 3em;"><label>%HP</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp>' +
'= <input type="number" size="1" id="HealMana" value="65" min="1" max="100" onchange="FixManaPercent()" style="width: 3em;"><label>%Mana</label><br /><br /><label>Auto-Script:</label>' +
...
' min="1" max="300" onchange="FixIntervals()" style="width: 3em;"><label> Sec</label><br /><label>Heal Interval:</label><input type="number" size="1" id="HealIntervalControl" value="5" min="1"' +
' max="400" onchange="FixIntervals()" style="width: 3em;"><label> Sec</label><label>&nbsp&nbsp&nbsp&nbsp&nbspCMD Interval:</label><input type="number" size="1" id="CommandIntervalControl" value="10"' +
...
var RunOnKillInterval = 100; 
var RestTimeAfterRunOnKill = 4000;
...
$("#mainScreen").append("<span style='color: cyan'>You will now run: </span><span style='color: yellow'>" + ScriptRunDirection + "<span style='color: cyan'>, and rest for 3 seconds after gaining EXP.</span><br />");
	} else {
