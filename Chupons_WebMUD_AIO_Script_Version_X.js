// *******************************************
// * Chupon's SuperScript (All IN ONE) ver.X * 
// *******************************************
...
//             **
// VERSION X   **             Here it is! Version X Baby. Path Recording oh yeah. Press Control + R to begin and end recording.
...
function InputBoxKeyChecker(e){
	...
	if ((e.ctrlKey) && (e.keyCode == 82)){ //If You Press Control+R Begin numpad path recording.
					...
					'<br />' +
					'//Insert The Lines Below Into the scripts path functions section.<br />' +
					...
					'<br />' +
					'<br />' +
					'//Insert the following sections into the script trigger cases<br />' +
					...
					'break;<br />' +
					'//End Of Case Code Insert<br />' +
					'<br />' +
					'<br />' +
					'// Please add: ' +', "#' + FullPathName + '", "#' + PathEndRoom + '2' + PathStartRoom + '" to the drop down path sections path array, to show these paths in the dropdown menu.<br />' +
					'</label></div>');
