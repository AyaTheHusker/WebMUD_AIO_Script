// *******************************************
// * Chupon's SuperScript (All IN ONE). v6.0 * 
// *******************************************
...
//Add New Elements> DropDownPath select box, and Blorgen's Exp/Rate Label.
$('<div>&nbsp&nbsp&nbsp&nbsp<select id="PathDropDown"; style="font-size: 20px; font-weight: bold"; onChange="PathDropDownSelection()"><option selected value="base">&nbsp&nbsp&nbsp&nbspPaths and Commands</select>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>Rest Below</label>&nbsp&nbsp<input type="number" size="1" id="RestMin" value="80" min="1" max="100" onchange="FixRestPercent()" style="width: 3em;"><label>%HP</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>Max</label>&nbsp&nbsp<input type="number" size="1" id="RestMax" value="100" min="1" max="100" onchange="FixRestPercent()" style="width: 3em;"><label>%HP</label></div><div style="float:left; padding:1em 0 0 1em;"><label>Auto-Script:</label><input type="checkbox" id="EnableScripting" onClick="ScriptingToggle()"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRun Dir: </label>&nbsp&nbsp<input type="text" size="2" id="RunDirection" value="nw">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type= "submit" value="UPDATE" onclick="UpdateRunRestDir()"><br /><br /><label>Auto-Heal</label><input type="checkbox" id="EnableHealing" onClick="HealingToggle()"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAuto-Buff</label><input type="checkbox" id="EnableBuffing" onClick="BuffingToggle()">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBuff Spell:</label><input type="text" size="2" id="BuffSpell" value="">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>Heal Spell:</label><input type="text" size="2" id="HealSpell" value=""><br /><br /><label>Buff Interval:</label><input type="number" size="1" id="BuffIntervalControl" value="120" min="1" max="300" onchange="FixIntervals()" style="width: 3em;"><label> Sec</label><br /><label>Heal Interval:</label><input type="number" size="1" id="HealIntervalControl" value="30" min="1" max="400" onchange="FixIntervals()" style="width: 3em;"><label id="#LabelSeconds"> Sec</label></div><div style="float:left; padding:1em 0 0 1em;"></div></span></div>').insertAfter("#divMainPanel");
...
var HealInterval = 30000; //GLOBALLY Initialize Heal Spell Interval
...
/////////////////////////////////////////  E N D    S P E L L S
// simple move and rest when needed, may not work on all browsers/systems
