// *******************************************
// * Chupon's SuperScript (All IN ONE). v9.5 * 
// *******************************************
...
//             **             Added Pre-Rest and Post-Rest commands. For more than one command, use commas. **Example: drop 1000 c,drop 500 c,wear coprolite necklace
//			   **
// Version 8   **
//			   **             Made the healing timer smart! Now healing tests the user's health and mana %s for better efficiency. Added auto-cmd array for non spell events. 
//             **             Similar to the pre-rest post-rest inputs, the auto-cmd input can execute multiple commands. Great for grabbing items or adding extra buffs.
//			   **			
